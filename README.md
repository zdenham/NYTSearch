...
* [x] List anything else that you can get done to improve the app functionality!
  I decided to use a thesaurus api to lookup similar terms to the search term and 
  load in data on scroll to give a true "endless scroll" effect. That way your
  search comes up with similar items, not just exact search matches.

## Video Walkthrough

Here's a walkthrough of implemented user stories:

![alt tag](https://raw.githubusercontent.com/zdenham/NYTSearch/master/NYTSearch.gif)
